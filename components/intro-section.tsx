  ...
  return (
    <section className="bg-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="text-lg text-gray-700 mb-8 space-y-4 max-w-3xl mx-auto">
          <p>Create a profitable 360°/VR Agency that scales.</p>
          <p>
            Then learn how to outsource the tasks of your entire business and step away while still pocketing the lion's
        ...
        <h3 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-12 leading-snug">
        ...
        <div className="text-left max-w-3xl mx-auto space-y-6 text-gray-700 leading-relaxed">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="mt-4">
                ...
                &#39;50s, the same thing happened to television. And now in this era we are ushering in the widespread
                use of virtual reality and an untapped diamond mine of opportunity is coming with it.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-8 rounded-lg my-8">
            ...
            <h5 className="text-xl font-semibold text-gray-800 mb-4 text-center">Even With Zero Experience.</h5>
            <p>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="space-y-4">
                <h5 className="text-lg font-semibold text-gray-800 mb-4 text-center">Before VTPS:</h5>
              ...
              <div className="space-y-4">
                <h5 className="text-lg font-semibold text-gray-800 mb-4 text-center">After VTPS:</h5>
                <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                  <img
          ...
          <div className="text-center">
            <h4 className="text-2xl font-bold text-gray-900 mb-8">Meet the Virtual Tour Profit System (VTPS)</h4>
            <div className="mb-8">
              <img
            ...
            <div className="text-left space-y-6 text-gray-700 leading-relaxed">
              ...
              <p>
                <strong>You can literally cut and paste your way to success.</strong>
              </p>
              ...
              <div className="my-16">
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-4">
                  ...
                  <div className="flex flex-col items-center text-center group">
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-2xl mb-4 transform transition-transform duration-200 group-hover:scale-105 shadow-lg will-change-transform">
                      1
                    </div>
                    <h3 className="font-bold text-xl text-gray-900 mb-2">Close the Deal</h3>
                  ...
                  <div className="hidden md:block">
                    <svg className="w-12 h-8 text-blue-400 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                  ...
                  {/* Step 2 */}
                  <div className="flex flex-col items-center text-center group">
                    <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center text-white font-bold text-2xl mb-4 transform transition-transform duration-200 group-hover:scale-105 shadow-lg will-change-transform">
                      2
                    </div>
                    <h3 className="font-bold text-xl text-gray-900 mb-2">Capture in 360</h3>
                    <p className="text-gray-600 max-xs">
                  ...
                  {/* Connector Arrow */}
                  <div className="hidden md:block">
                    <svg className="w-12 h-8 text-green-400 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                        d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
                        clipRule="evenodd"
                  ...
                  {/* Step 3 */}
                  <div className="flex flex-col items-center text-center group">
                    <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-2xl mb-4 transform transition-transform duration-200 group-hover:scale-105 shadow-lg will-change-transform">
                      3
                    </div>
                    <h3 className="font-bold text-xl text-gray-900 mb-2">Deliver & Profit</h3>
                    <p className="text-gray-600 max-w-xs">
              ...
              <h5 className="font-semibold text-gray-900 mt-8 mb-6 text-2xl">The Journey Inside VTPS</h5>
          ...
          <div className="mt-16">
            <div className="text-center mb-8">
              <h4 className="font-bold text-gray-900 mb-2 text-2xl">Built On Results</h4>
              <p className="text-xl text-gray-600">and</p>
              <h5 className="text-2xl font-semibold text-gray-900">A Step by Step Framework</h5>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto mb-16">
              ...
              <div className="space-y-6">
                <div className="text-center">
                  <h6 className="text-xl font-bold text-gray-900">Stephen Farrel - Baltimore Maryland</h6>
                  <p className="text-lg text-gray-700">CEO of Clover Sky Media</p>
                  <p className="text-lg font-semibold text-blue-600">"Closes 5 Clients in 5 Days With VTPS."</p>
                </div>
              ...
              <div className="space-y-6">
                <div className="text-center">
                  <h6 className="text-xl font-bold text-gray-900">Andy Crozier - United Kingdom</h6>
                  <p className="text-lg text-gray-700">Owner of Insight Photography</p>
                  <p className="text-lg font-semibold text-blue-600">"Got Started In 3 Weeks With VTPS"</p>
                </div>
                <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden shadow-lg">
                  <iframe
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="font-medium">
                      We give you all the content, emails, brochures, scripts, proposals, pitch decks and marketing
                      stuff you'd ever need.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-20">
              <div className="text-center mb-12">
                <h4 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-8">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="flex flex-col items-center text-center space-y-8">
                  <div className="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                      <p className="text-lg">
                        And beyond that, there's the selfish stuff, too. A nicer car. A bigger house. More vacations.
                        Better retirement. Peace of mind. Fancy clothes. Fancy restaurants. Fancy everything.
                      </p>
                      ...
                      <div className="bg-green-50 p-6 rounded-lg border border-green-200 max-w-2xl mx-auto">
                        <p className="text-lg font-medium text-gray-900">
                          And the best part is that there's a whole module in VTPS about how to build a team to take
                          over so you can have more time for yourself and your family.
                        </p>
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8 text-center">
                  ...
                  <blockquote className="text-lg text-gray-700 italic leading-relaxed">
                    "Here is a success story I had a virtual talk with you on an idea because I needed some advice and
                    to brainstorm prices. I ran with the idea and advice 2 days later I closed a 10,500 deal with one
                    client with potential to add in 100 more virtual tours."
                  </blockquote>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8 text-center">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Watch Ron share his incredible success story and how he generated over $10,000 using the VTPS system
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8 text-center">
                  <div className="mb-6">
                    <h6 className="text-2xl font-bold text-gray-900 mb-2">
                      Hear How Bobby Got His First 2 Clients Fast
                    </h6>
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8 text-center">
                  ...
                  <blockquote className="text-lg text-gray-700 italic leading-relaxed">
                    "Within days of watching your YouTube videos, I had a new Insta360 One X, built a tour of my own
                    house, and landed a hotel/function center contract for $600. One week further in, and I have secured
                    an engineering company, and am in negotiations with an RV/Caravan manufacturer, and an interior
                    design firm."
                  </blockquote>
                </div>
            ...
            <div className="mt-20">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Experience the professional quality virtual tours you'll be creating for your high-paying clients.
                  These tours were created with the same CloudPano Pro+ platform included in your 360º Profit System.
                </p>
              </div>
          ...
          <div className="mt-20">
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  If you work in photography, media, digital marketing, technology, or any type of local service, you
                  can launch into VTPS as a no-brainer business model that plugs into your business.
                </p>
                <p>
                  And if you just want to launch VR Tours as its own standalone offer – that's fine too! That's what
                  some of my most successful students are doing.
                </p>
                <p>
                  Either way it's possible to start from zero and start making a six-figure income in what I think is
                  the easiest way on the planet.
                </p>
                <p>
                  If you simply ask the right people in the right way (which we'll teach you) people will raise their
                  hand, chase you down, and throw money at you for this service.
                </p>
                <p className="font-semibold text-gray-900">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start space-x-4 bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Best practices for Facebook and Google ads that get clients.
                    </p>
                  </div>
                </div>
              ...
              <div className="text-center mt-12">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-8 rounded-lg border border-green-200">
                  ...
                  <h6 className="text-xl font-bold text-blue-600 mb-4">The Virtual Tour Profit System</h6>
                  <p className="text-lg text-gray-700">
                    This comprehensive system removes all guesswork and gives you a proven roadmap to building a
                    profitable VR business.
                  </p>
                </div>
              </div>
            </div>
