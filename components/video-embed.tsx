  ...
  return (
    <>
      ...
      {enableStickyOnScroll && showStickyVideo && (
        <div
          className={`fixed ${getStickyPositionClasses()} z-50 w-80 bg-background/95 backdrop-blur-sm rounded-xl shadow-2xl border border-border/50 overflow-hidden animate-in slide-in-from-right-4 duration-300`}
        >
